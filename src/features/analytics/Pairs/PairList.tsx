...
const allColumns = [
  ...
  },
  {
    ...
    accessor: (row) => (
      <div>
        <div className="font-medium text-high-emphesis">
          {formatNumber(row.volume1d * 0.003, true, false, 2)}
        </div>
        <div className="font-normal text-primary">
          {formatNumber(row.volume1w * 0.003, true, false, 2)}
        </div>
      </div>
    ),
    align: "right",
  ...
  },
  {
    ...
    accessor: (row) => (
      <div className="inline-flex flex-col">
        <div className="font-medium text-high-emphesis">
          <ColoredNumber
            number={row.liquidityChangeNumber1d}
            scaleNumber={false}
          />
        </div>
    ...
    align: "right",
    sortType: (a, b) =>
      a.original.liquidityChangeNumber1d - b.original.liquidityChangeNumber1d,
  },
  {
    Header: "%",
    accessor: (row) => (
      <div className="inline-flex">
        <div>
          <div className="font-medium text-high-emphesis">
            {formatPercent(row.liquidityChangePercent1d)}
          </div>
    ...
    align: "right",
    sortType: (a, b) =>
      a.original.liquidityChangePercent1d - b.original.liquidityChangePercent1d,
  },
  {
    ...
    accessor: (row) => (
      <div className="inline-flex flex-col">
        <div className="font-medium text-high-emphesis">
          <ColoredNumber
            number={row.volumeChangeNumber1d}
            scaleNumber={false}
          />
        </div>
    ...
    align: "right",
    sortType: (a, b) =>
      a.original.volumeChangeNumber1d - b.original.volumeChangeNumber1d,
  },
  {
    Header: " %",
    accessor: (row) => (
      <div className="inline-flex">
        <div>
          <div className="font-medium text-high-emphesis">
            {formatPercent(row.volumeChangePercent1d)}
          </div>
    ...
    align: "right",
    sortType: (a, b) =>
      a.original.volumeChangePercent1d - b.original.volumeChangePercent1d,
  },
];
