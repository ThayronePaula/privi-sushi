  ...
  return !trade ? null : (
    <div className="flex flex-col space-y-2">
      ...
      <RowBetween>
        ...
        <div className="text-sm font-bold text-high-emphesis">
          {realizedLPFee
            ? `${realizedLPFee.divide(6).multiply(5).toSignificant(4)} ${
      ...
      <RowBetween>
        <RowFixed>
          ...
          <QuestionHelper
            text={i18n._(
              t`A portion of each trade (0.05%) goes to xSUSHI holders as a protocol incentive.`
            )}
          />
        </RowFixed>
        <div className="text-sm font-bold text-high-emphesis">
      ...
      {minerBribe && (
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper
              text={i18n._(
                t`Tip to encourage miners to select this transaction.`
              )}
            />
          </RowFixed>
          <div className="text-sm font-bold text-high-emphesis">
